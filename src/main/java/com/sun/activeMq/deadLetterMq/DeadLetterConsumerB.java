...
public class DeadLetterConsumerB {
    ...
    public static void main(String[] args) {
        ...
        //实例化连接工厂
        connectionFactory = new ActiveMQConnectionFactory(DeadLetterConsumerB.USERNAME,
        		DeadLetterConsumerB.PASSWORD, DeadLetterConsumerB.BROKEURL);
