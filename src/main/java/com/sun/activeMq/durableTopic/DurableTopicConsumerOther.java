...
public class DurableTopicConsumerOther {
    ...
    public static void main(String[] args) {
        ...
        //实例化连接工厂
        connectionFactory = new ActiveMQConnectionFactory(DurableTopicConsumerOther.USERNAME, DurableTopicConsumerOther.PASSWORD, DurableTopicConsumerOther.BROKEURL);
